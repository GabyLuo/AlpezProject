        ...
        <div class="col-sm-6">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left">
              ...
              <q-breadcrumbs-el class="fs20" label="Nuevo" />
              </q-breadcrumbs>
          </div>
        </div>
      </div>
        ...
        <div class="col q-pa-md">
          ...
          <div class="row q-col-gutter-xs">
            <div class="col-xs-12 col-sm-4">
              <q-input class="uppcase" color="white" borderless bg-color="secondary" filled dark v-model="rol.fields.name" :error="$v.rol.fields.name.$error" :rules="[val => !!val || 'Campo requerido']" label="Rol">
          ...
          <div class="row q-mb-sm">
            <div class="col-xs-12 col-sm-2 offset-sm-10 pull-right">
              <q-btn color="positive" icon="save" label="Guardar" @click="createRol()" />
            </div>
          </div>
        </div>
      </div>
