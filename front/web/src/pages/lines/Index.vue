        ...
        <div class="col-sm-8">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left" style="font-size: 20px">
              ...
              <q-breadcrumbs-el label="Subcategorías" />
            </q-breadcrumbs>
          </div>
        </div>
        <div class="col-xs-6 col-md-4 pull-right">
          <div class="q-pa-sm q-gutter-sm">
            <q-btn class="bg-primary" style="color: white" icon="add" label="Nuevo" @click.native="$router.push('/lines/new')" />
          </div>
        </div>
      </div>
    </div>
          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="category" style=" text-align: left;" :props="props">{{ props.row.category_name }}</q-td>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'category', align: 'center', label: 'CATEGORÍAS', field: 'category_name', sortable: true },
