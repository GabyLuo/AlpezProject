        ...
        <div class="col q-pa-md">
          ...
          <div class="row q-mb-sm q-mt-md">
            <div class="col-xs-12 col-sm-2 offset-sm-10 pull-right">
              <q-btn color="positive" icon="save" label="Guardar" @click="createExchange()" />
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    createExchange () {
      ...
      params.current_value = Number({ ...this.exchange.fields }.current_value) // Valor
      params.currency_id = { ...this.exchange.fields }.currency.value // Tipo de moneda
      console.log(params)
      api.post('/exchanges', params).then(({ data }) => {
        this.$q.notify({
