        ...
        <div class="col-sm-8">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left" style="font-size: 20px">
              ...
              <q-breadcrumbs-el label="Unidades" />
            </q-breadcrumbs>
          </div>
        </div>
        <div class="col-xs-6 col-md-4 pull-right">
          <div class="q-pa-sm q-gutter-sm">
            <q-btn class="bg-primary" style="color: white" icon="add" label="Nuevo" @click.native="$router.push('/units/new')" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col q-pa-md">
          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                <q-td key="code" style="width: 20%; text-align: center;" :props="props">{{ props.row.code }}</q-td>
                <q-td key="name" style="width: 50%; text-align: left;" :props="props">{{ props.row.name }}</q-td>
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        { name: 'code', align: 'center', label: 'CÓDIGO', field: 'code', style: 'width: 20%', sortable: true },
