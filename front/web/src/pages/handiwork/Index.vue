        ...
        <div class="col-sm-8">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left" style="font-size: 20px">
              ...
              <q-breadcrumbs-el label="Mano de Obra" />
            </q-breadcrumbs>
          </div>
        </div>
        <div class="col-xs-6 col-md-4 pull-right">
          <div class="q-pa-sm q-gutter-sm">
            <q-btn class="bg-primary" style="color: white" icon="add" label="Nuevo" @click.native="$router.push('/works/new')" />
          </div>
        </div>
      </div>
    </div>
          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <!--<q-td key="time_job" style=" text-align: center;" :props="props">{{ props.row.time_job }}</q-td>-->
                <q-td key="price" style=" text-align: right;" :props="props">{{ props.row.price }}</q-td>
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'price', align: 'center', label: 'COSTO POR HORA', field: 'price', sortable: true },
  ...
  methods: {
    ...
    deleteSelectedRow (id) {
      this.$q.dialog({
        title: 'Confirmación',
        message: '¿Desea eliminar esta mano de obra?',
        persistent: true,
        ok: {
          label: 'Aceptar',
          color: 'green'
