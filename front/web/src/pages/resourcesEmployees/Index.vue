        ...
        <div class="col-sm-8">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left" style="font-size: 20px">
              ...
              <q-breadcrumbs-el label="Empleados" />
            </q-breadcrumbs>
          </div>
        </div>
        <div class="col-xs-6 col-md-4 pull-right">
          <div class="q-pa-sm q-gutter-sm">
            <q-btn class="bg-primary" style="color: white" icon="add" label="Nuevo" @click.native="$router.push('/employees/new')" />
          </div>
        </div>
      </div>
    </div>
          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td key="department" style="text-align: left;" :props="props">{{ props.row.departments }}</q-td>
                <q-td key="area" style="text-align: left;" :props="props">{{ props.row.area }}</q-td>
                <q-td key="position" style="text-align: left;" :props="props">{{ props.row.puesto }}</q-td>
                <q-td key="name" style="text-align: left;" :props="props">{{ props.row.name +' '+ props.row.paternal +' '+ props.row.mathers}}</q-td>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'department', align: 'center', label: 'DEPARTAMENTOS', field: 'department', sortable: true },
        { name: 'area', align: 'center', label: 'ÁREAS', field: 'area', sortable: true },
