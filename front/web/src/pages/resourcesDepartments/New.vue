        ...
        <div class="col-sm-9">
          <div class="q-pa-md q-gutter-sm">
            <q-breadcrumbs align="left" style="font-size: 20px">
              ...
              <q-breadcrumbs-el label="Nuevo Departamento" />
            </q-breadcrumbs>
          </div>
        </div>
      </div>
        ...
        <div class="col q-pa-md">
          ...
          <div class="row q-mb-sm q-mt-md">
            <div class="col-xs-12 col-sm-2 offset-sm-10 pull-right">
              <q-btn color="positive" icon="save" label="Guardar" @click="createDepartment()" />
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    nameRules (val) {
      return [
        ...
        val => (this.$v.department.fields.name.maxLength) || 'El campo Nombre no debe exceder los 30 dígitos.'
      ]
    }
  },
  beforeCreate () {
  ...
  methods: {
    createDepartment () {
      ...
      api.post('/departments', params).then(({ data }) => {
        this.$q.notify({
