...
class AuthoSendMail extends Controller
{
    ...
    public function generatePDF2()
    {
        ...
        $pdf = new mailPDF2();
        $image_path = $_SERVER['DOCUMENT_ROOT'] . '/public/logo/';
    ...
    public function sendPdfToProvider()
    {
        ...
        $user = array_values(json_decode('[
            ...
            {"email":"logistica@alpezgas.com", "language":"en"}
        ]', true));
        $fileName = __DIR__ . '/../../public/station/';
        $mailsEs = [];
...
class mailPDF extends FPDF
{
    ...
    {
        $image_path =  __DIR__ . '/../../public/logo/';
